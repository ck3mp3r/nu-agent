...
pub(super) fn input_prompt_prefix(mode: crate::agent::ui::tui::state::InputMode) -> &'static str {
    match mode {
...
pub(super) fn command_palette_action_summary(action: CommandPaletteAction) -> &'static str {
    match action {
...
pub(super) fn command_palette_action_label(action: CommandPaletteAction) -> &'static str {
    match action {
...
pub(super) fn mcp_state_label(state: McpServerUsabilityState) -> &'static str {
    match state {
...
pub(super) fn mcp_status_icon(state: McpServerUsabilityState) -> &'static str {
    match state {
...
#[cfg(test)]
pub(super) fn help_panel_visible_window(
    lines: &[Line<'_>],
    content_width: usize,
    scroll: usize,
    rows: usize,
