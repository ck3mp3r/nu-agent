...
use crate::commands::agent::ui::tui::interaction::input::{TerminalEvent, TerminalKey};
    ...
    match event {
        Event::Resize(columns, rows) => {
            Some(TerminalEvent::Resize(
                crate::commands::agent::ui::tui::interaction::input::TerminalResize {
                columns,
                rows,
                },
            ))
...
fn parse_script_token(token: &str) -> Option<TerminalEvent> {
    use crate::commands::agent::ui::tui::interaction::input::TerminalResize;
