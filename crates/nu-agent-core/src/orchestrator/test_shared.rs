...
#[derive(Default)]
pub(crate) struct MailboxTestRuntime {
    pub(crate) prompts: Vec<String>,
    pub(crate) clear_session_calls: usize,
}
...
crate::default_compaction!(MailboxTestRuntime);

pub(crate) struct MailboxTestUi {
    pub(crate) submitted: std::collections::VecDeque<String>,
    pub(crate) quit: bool,
    pub(crate) clear_transcript_calls: usize,
    pub(crate) displayed_incoming_messages: Vec<String>,
}
