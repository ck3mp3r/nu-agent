...
use crate::protocol::preamble::ModelFamily;

const GITHUB_COPILOT_OPENAI_GPT5X_DEFAULT: &str = include_str!("github_copilot_openai_gpt5x.md");
const GITHUB_COPILOT_OPENAI_GPT4X_DEFAULT: &str = include_str!("github_copilot_openai_gpt4x.md");
const GITHUB_COPILOT_ANTHROPIC_DEFAULT: &str = include_str!("github_copilot_anthropic.md");
const GITHUB_COPILOT_ANTHROPIC_SONNET_DEFAULT: &str =
    include_str!("github_copilot_anthropic_sonnet.md");
const OPENAI_GPT5X_DEFAULT: &str = include_str!("openai_gpt5x.md");
const OPENAI_GPT4X_DEFAULT: &str = include_str!("openai_gpt4x.md");
const ANTHROPIC_DEFAULT: &str = include_str!("anthropic.md");
const GLOBAL_FALLBACK_DEFAULT: &str = include_str!("global_fallback.md");
